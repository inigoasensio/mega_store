...
(function() {
  $(function() {
    return $('#cart .fi-x').click(function(e) {
      var $this, url;
      e.preventDefault();
      $this = $(this).closest('a');
      url = $this.data('url');
      return $.ajax({
        ...
        success: function(data) {
          ...
          return $this.closest('.cart-row').slideUp();
        }
      });
    });
  });
  ...
  $(function() {
    return $('form[data-remote]').on('ajax:success', function(e, data) {
      e.preventDefault();
      return $('.cart-count').html(data.cart_count);
    });
  });
