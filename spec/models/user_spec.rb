...
RSpec::describe User, type: :model do
  ...
  describe 'associations' do
    ...
    it { is_expected.to have_many(:orders).through(:purchases) }
    it { is_expected.to have_many(:purchases) }
    it { is_expected.to have_many(:addresses) }
  end

  describe 'attributes' do
    it { is_expected.to allow_mass_assignment_of(:first_name) }
    it { is_expected.to allow_mass_assignment_of(:last_name) }
